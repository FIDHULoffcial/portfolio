/* ================================================================
   FIDHUL KRISHNA â€” script.js  (v3 â€” Unified)
   All behavior wired to: sound.js (SE), GitHub API, YouTube link.
   Section order: hero â†’ about â†’ timeline â†’ skills â†’ projects â†’
                  achievements â†’ ventures â†’ github â†’ content â†’
                  social â†’ contact
   ================================================================ */

document.addEventListener('DOMContentLoaded', () => {

    /* â”€â”€ Social & API constants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    const GH_USER = 'FIDHULofficial';
    ...
    /* â”€â”€ Language â†’ GitHub official colour â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
    const LANG_COLORS = {
    ...
    function runIntro() {
        // Step 1 (0s)    â€” FIDHUL rises slowly from below (1.6s CSS transition)
        setTimeout(() => introFirst.classList.add('show'), 0);

        // Step 2 (1.0s)  â€” KRISHNA rises
        setTimeout(() => introLast.classList.add('show'), 1000);

        // Step 3 (2.5s)  â€” HR rule draws left-to-right
        setTimeout(() => introRule.classList.add('show'), 2500);

        // Step 4 (3.1s)  â€” Subtitle rises
        setTimeout(() => introSub.classList.add('show'), 3100);

        // Step 5         â€” Name holds on screen (dramatic pause)

        // Step 6 (4.5s)  â€” Gold squares pulse in
        setTimeout(() => introDots.classList.add('show'), 4500);

        // Step 7 (5.0s)  â€” Fade out intro, reveal page
        setTimeout(() => {
    ...
    /* ================================================================
       5. NAVBAR â€” scroll shadow + active link highlight
       ================================================================ */
    ...
    /* ================================================================
       9. GITHUB PROFILE FETCH
          Fetches user profile â†’ populates:
    ...
    async function fetchGitHubProfile() {
        ...
        // â”€â”€ Populate sys.info avatar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        const avatarWrap = document.getElementById('sysAvatar');
        if (avatarWrap && profile.avatar_url) {
            avatarWrap.innerHTML = `
        <img class="sys-avatar"
             src="${profile.avatar_url}"
             alt="Fidhul Krishna â€” GitHub avatar"
             loading="lazy">`;
        }

        // â”€â”€ Repo count in sys.info â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        const sysRepos = document.getElementById('sysRepos');
        if (sysRepos) sysRepos.textContent = profile.public_repos || 'â€”';

        // â”€â”€ Followers in about stats â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        const followersStat = document.getElementById('ghFollowersStat');
        if (followersStat) {
            followersStat.textContent = profile.followers || 'â€”';
            followersStat.removeAttribute('data-count'); // prevent counter override
        }

        // â”€â”€ Social card stats â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        const ghRepoCount = document.getElementById('ghRepoCount');
        const ghFollowerCount = document.getElementById('ghFollowerCount');
        if (ghRepoCount) ghRepoCount.textContent = profile.public_repos || 'â€”';
        if (ghFollowerCount) ghFollowerCount.textContent = profile.followers || 'â€”';
    }
    ...
    /* ================================================================
       10. GITHUB REPOS FETCH
           Fetches public repos â†’ renders cards in #ghGrid.
    ...
    async function fetchRepos() {
        ...
        // Live fetch
        try {
            if (ghStatus) ghStatus.textContent = 'CONNECTING TO GITHUBâ€¦';
            ...
            renderRepos(data);
            if (ghCacheTime) ghCacheTime.textContent = 'LIVE â€” REFRESHES DAILY';
        } catch (err) {
